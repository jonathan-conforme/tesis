		...
		<div class="branding">
			<div class="container-fluid">
				<nav class="main-nav navbar navbar-expand-lg">
                    ...
                    <div>
                <a href="<?php echo e(route('inicio')); ?>" class="site-logo ">
    ...
    <div class="container">
        ...
        <ul class="schedule-nav nav nav-pills nav-fill" id="myTab" role="tablist">
            <li class="nav-item me-2">
				...
				<span class="heading"><?php echo e(\Carbon\Carbon::now()->translatedFormat('l, d F')); ?></span>

                    <span class="meta">(Miércoles <?php echo e(date('d, M')); ?>)</span>
                </a>
            </li>
        </ul>
            ...
            <div class="tab-pane active" id="tab-1-content" role="tabpanel" aria-labelledby="tab-1">
				...
				<br><br>
                    <div class="meta">
						...
						<div class="profile">
                            <a href="#modal-speaker-<?php echo e($cronograma->id); ?>" data-bs-toggle="modal" data-bs-target="#modal-speaker-<?php echo e($cronograma->id); ?>">
                                <img class="profile-image rounded-circle mb-2" src="<?php echo e(asset('storage/' . $cronograma->foto)); ?>" alt="">
                            </a> 
                            <div class="name">
                                <a class="theme-link" href="#modal-speaker-<?php echo e($cronograma->id); ?>" data-bs-toggle="modal" data-bs-target="#modal-speaker-<?php echo e($cronograma->id); ?>">
                    ...
                    <div class="content">
                        ...
                        <div class="location mb-3"><i class="fas fa-map-marker-alt me-2"></i><?php echo e($cronograma->lugar); ?></div>
                        <div class="desc">
...
<?php /**PATH C:\xampp\htdocs\tesis\resources\views/inicio.blade.php ENDPATH**/ ?>