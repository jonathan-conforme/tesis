                    ...
                    <div class="modal-dialog">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                ...
                                <form action="<?php echo e(route('ponencias.store')); ?>" method="POST" enctype="multipart/form-data">
                                    <?php echo csrf_field(); ?>
                            ...
                            <table class="table table-striped table-hover w-full bg-white dark:bg-gray-800 shadow-md rounded-lg border border-gray-300 dark:border-gray-700">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center py-4 px-6"><?php echo e($ponencia->titulo); ?></td>
                                        <td class="text-center py-4 px-6"><?php echo e($ponencia->tematica); ?></td>
                                        ...
                                        <td class="py-4 px-6 text-gray-600 dark:text-gray-300 text-center"><?php echo e($ponencia->observaciones); ?></td>
                                        <td class="py-4 px-6 text-gray-600 dark:text-gray-300 text-center">

                                            <?php if($ponencia->estado === 'rechazado'): ?>
                                            <?php if($ponencia->puedeReemplazar()): ?> 
                                            <span class="text-yellow-500">Fecha de entrega: <?php echo e($ponencia->fecha_entrega ?? 'No disponible'); ?></span>
                                            <form action="<?php echo e(route('ponencias.updateArchivo', $ponencia->id)); ?>" method="POST" enctype="multipart/form-data">
                                                <?php echo csrf_field(); ?>
                                            ...
                                            <?php else: ?>
                                            <a href="<?php echo e(asset('storage/' . $ponencia->archivo)); ?>" target="_blank" class="text-blue-500 hover:underline">
...
<?php endif; ?><?php /**PATH C:\xampp\htdocs\tesis\resources\views/ponencia/create.blade.php ENDPATH**/ ?>