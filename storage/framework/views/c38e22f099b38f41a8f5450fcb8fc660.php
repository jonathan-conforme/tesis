...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.input-label','data' => ['for' => 'name','value' => __('Nombre y Apellido')]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['for' => 'name','value' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(__('Nombre y Apellido'))]); ?>
...
<?php endif; ?>
        ...
        <div class="form-check">
            <input class="form-check-input" type="radio" name="terms" id="termsRadio" required>
            <label class="form-check-label " for="termsRadio">
                Acepto los <a href="#" data-bs-toggle="modal" data-bs-target="#termsModal" class="link-primary link-offset-2 link-underline-opacity-25 link-underline-opacity-100-hover">términos y condiciones</a>
            </label>
        </div> 
        ...
        <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <p>
                        Al aceptar estos términos y condiciones, reconoces y consientes que los datos que ingresas en este sistema serán utilizados para los fines establecidos, tales como la gestión de tu cuenta, la prestación de servicios personalizados y la mejora continua de nuestras funcionalidades. Nos comprometemos a proteger tu información conforme a las normativas de protección de datos aplicables. 
                    </p>
                    <p>
                        Tus datos no serán compartidos con terceros sin tu consentimiento explícito, salvo cuando sea requerido por la ley. Asegúrate de que la información proporcionada sea precisa y verídica, ya que de ello depende la correcta prestación de nuestros servicios.
                    </p>
                </div>
...
<?php endif; ?>
<?php /**PATH C:\xampp\htdocs\tesis\resources\views/auth/register.blade.php ENDPATH**/ ?>